...
export const metadata = buildMetadata({
  ...
  description:
    "تصفّح دورات معهد إعداد دعاة التوحيد والسنة في التفسير والفقه والحديث والعقيدة وغيرها من العلوم الشرعية، على منهج أهل السنة والجماعة، للمبتدئين والمتوسطين والمتقدمين.",
  path: "/courses/",
});
