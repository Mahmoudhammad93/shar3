...
export default async function AboutPage() {
  ...
  return (
    <SiteLayout>
      <PageHero title="عن المعهد" subtitle={settings.tagline_ar} />
      <Container className="py-16">
        <div className="mx-auto max-w-4xl space-y-8">
          <Card>
            <CardContent className="p-8">
              <h2 className="mb-4 text-2xl font-bold text-brand-dark">من نحن</h2>
              <p className="leading-8 text-muted">{settings.about_ar}</p>
            </CardContent>
          </Card>
          <div className="grid gap-6 md:grid-cols-2">
            <Card className="bg-brand text-white">
              <CardContent className="p-8">
                ...
                <p className="leading-7 text-white/90">{settings.vision_ar}</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-8">
                <h3 className="mb-3 text-xl font-bold text-brand-dark">رسالتنا</h3>
                <p className="leading-7 text-muted">{settings.mission_ar}</p>
              </CardContent>
            </Card>
          </div>
        </div>
